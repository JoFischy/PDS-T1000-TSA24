...
g++ -std=c++17 -O3 -DNDEBUG -Wall -Iexternal/raylib/src -Iinclude -Isrc/pybind11/include -I"C:/Program Files/Python311/include" src/main.cpp src/py_runner.cpp src/car_simulation.cpp src/auto.cpp src/point.cpp src/renderer.cpp src/coordinate_filter.cpp src/coordinate_filter_fast.cpp src/test_window.cpp -Lexternal/raylib/src -lraylib -lopengl32 -lgdi32 -lwinmm -L"C:/Program Files/Python311/libs" -lpython311 -o main
